...
<div class="container">
    ...
    <div class="form-control">
            ...
            <input type="text" name="prodel" placeholder="Enter Agency Name:" required ="fill this field first">
        </div>
        <div class="form-control">
            <label>Delievery Address</label>
            <input type="text" name="proadd" placeholder="Enter Agency Address:" required="fill this field first">
        </div>
        <div class="form-control">
            <label>Product Name</label>
            <input type="text" name="proname" placeholder="Enter Product Name:" required="fill this field first">
        </div>
        <div class="form-control">
